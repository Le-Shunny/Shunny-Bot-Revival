...
module.exports.config = {
  ...
  description: "Engage in conversation with Sofia! Experience some similarities with Sim",
  commandCategory: "chatbots",
  usages: "Simv2 2 in 1 command sim, teach",
  cooldowns: 2,
};
...
module.exports.run = function ({ api, event, args }) {
  ...
  try {
    const jsonFile = fs.readFileSync(__dirname + "/dan.json", "utf-8");
        ...
        if (responses[lowercaseWord]) {
          if (response) {
            ...
            if (index !== -1) {
              ...
              fs.writeFileSync(__dirname + "/dan.json", JSON.stringify(responses, null, 4), "utf-8");
